                                ...
                                <div class="product-image-wrapper">
                                    <div class="single-products">
                                        <div class="productinfo text-center">
                                            <? echo Html::img("@web/images/products/{$product->img}", ['alt' => $product->name]) ?>
                                        ...
                                        <?php if($product->new): ?>
                                            <? echo Html::img("@web/images/home/new.png", ['alt' => 'Новинка', 'class' => 'new']) ?>
                                        <?php endif ?><?php if($product->sale): ?>
                                            <? echo Html::img("@web/images/home/sale.png", ['alt' => 'Распродажа', 'class' => 'new']) ?>
                                        <?php endif ?>
                                    </div>
                                    <div class="choose">
